...
<div id="about" class="nav-content">
	<table class="form-table">
		...
		<?php else : ?>
			...
			<?php if ( get_option('woo_custom_installments_alternative_license_activation') === 'yes' ) : ?>
				<tr>
					<td>
						<h3><?php esc_attr_e( 'Notamos que teve problemas de conexão ao tentar ativar sua licença', 'woo-custom-installments' ); ?></h3>
