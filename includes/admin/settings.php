...
<div class="toast updated-option-success show">
...
if ( $this->deactive_license ) {
    ?>
    <div class="toast toast-warning show">
...
if ( $this->product_not_allowed ) {
    ...
    <div class="toast toast-danger show">
        ...
        <div class="toast-body"><?php echo esc_html__( 'A licença não é permitida para este produto.', 'woo-custom-installments' ) ?></div>
    </div>
    <?php
}
