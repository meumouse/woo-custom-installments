...
<div id="popup-pro-notice">
    <div id="pro-notice-content">
        <div class="popup-header">
            <h5 class="popup-title"><?php _e( 'Este recurso está disponível na versão Pro', 'woo-custom-installments' ); ?></h5>
            <button id="close-pro-notice" class="btn-close fs-lg" aria-label="Fechar"></button>
        </div>
        <div class="popup-body">
            <span class="fs-lg mt-3 mb-3 d-block"><?php _e( 'Compre uma licença Pro para desbloquear todos os recursos!', 'woo-custom-installments' ); ?></span>
            <a class="btn btn-primary my-4 pulsating-button purchase-button" href="https://meumouse.com/plugins/parcelas-customizadas-para-woocommerce/?utm_source=wordpress&utm_medium=plugin-settings&utm_campaign=parcelas_customizadas#buy-pro" target="_blank">
            ...
            <div class="license-form">
                <form method="post" action="" class="woo-custom-installments-form-license" name="woo-custom-installments-license">
                    <input type="hidden" name="woo-custom-installments-license" value="1"/>
                        <span class="d-block my-2"><?php echo esc_html__( 'Ou se já tiver uma licença, insira o código abaixo e clique em Ativar licença', 'woo-custom-installments' ) ?><a class="fancy-link ms-2" href="https://meumouse.com/minha-conta/licenses/" target="_blank"><?php echo esc_html__( 'Consultar minhas licenças', 'woo-custom-installments' ) ?></a></span>
                        <div class="input-group mt-3" style="width: 550px;">
...
<div class="woo-custom-installments-wrapper">
    ...
    <form method="post" action="" class="woo-custom-installments-form" name="woo-custom-installments">
        ...
        include_once WOO_CUSTOM_INSTALLMENTS_INC . 'admin/tabs/payment_forms.php';
        include_once WOO_CUSTOM_INSTALLMENTS_INC . 'admin/tabs/design.php'; ?>

        <form method="post" action="" class="woo-custom-installments-form-license" name="woo-custom-installments-license">
            <input type="hidden" name="woo-custom-installments-license" value="1"/>
            <?php include_once WOO_CUSTOM_INSTALLMENTS_INC . 'admin/tabs/about.php'; ?>
        </form>
    </form>
</div>