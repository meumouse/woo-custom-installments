...
<div class="woo-custom-installments-wrapper">
    <div class="nav-tab-wrapper woo-custom-installments-tab-wrapper">
        ...
        <a href="#general" class="nav-tab ">
            ...
            <?php esc_html_e( 'Geral', 'woo-custom-installments' ) ?></a>
        </a>
        ...
        <a href="#text" class="nav-tab ">
            ...
            <?php esc_html_e( 'Textos', 'woo-custom-installments' ) ?>
        </a>
        ...
        <a href="#discount" class="nav-tab ">
            ...
            <?php esc_html_e( 'Descontos', 'woo-custom-installments' ) ?>
        </a>
        ...
        <a href="#interests" class="nav-tab ">
            ...
            <?php esc_html_e( 'Juros', 'woo-custom-installments' ) ?>
        </a>
        ...
        <a href="#payment" class="nav-tab ">
            ...
            <?php esc_html_e( 'Formas de pagamento', 'woo-custom-installments' ) ?>
        </a>
        ...
        <a href="#design" class="nav-tab ">
            ...
            <?php esc_html_e( 'Estilos', 'woo-custom-installments' ) ?>
        </a>
        ...
        <a href="#about" class="nav-tab ">
            ...
            <?php esc_html_e( 'Sobre', 'woo-custom-installments' ) ?></a>
        </a>
