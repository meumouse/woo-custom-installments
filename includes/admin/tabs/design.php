...
<div id="design-settings" class="nav-content ">
   <table class="form-table" >
      ...
      <tr>
        <th>
           <?php echo esc_html__( 'Centralizar melhor parcela e desconto no produto individual', 'woo-custom-installments' ) ?>
           <span class="woo-custom-installments-description"><?php echo esc_html__('Se ativo, irá centralizar a melhor parcela e desconto no produto individual.', 'woo-custom-installments' ) ?></span>
        </th>
        <td>
           <div class="form-check form-switch">
              <input type="checkbox" class="toggle-switch" id="center_group_elements_single_product" name="center_group_elements_single_product" value="yes" <?php checked( isset( $options['center_group_elements_single_product'] ) == 'yes' ); ?> />
           </div>
        </td>
      </tr>
      <tr>
      ...
      <tr>
         <th>
            ...
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'A cor de fundo será gerada automaticamente com 10% de transparência a partir da cor informada. Esta configuração também altera a cor do emblema de aprovação imediata e desconto no checkout.' ) ?></span>
         </th>
         <td>
      ...
      <tr>
         <th>
            ...
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'Raio da borda do emblema do preço com desconto.' ) ?></span>
         </th>
         <td>
            <div class="input-group">
      ...
      <tr>
         <th>
            ...
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'Informe uma classe de ícone do Font Awesome. Ou deixe em branco para não exibir.' ) ?></span><a class="fancy-link mt-2" href="https://fontawesome.com/icons" target="_blank"><?php echo esc_html__( 'Acessar Font Awesome', 'woo-custom-installments' ) ?></a>
         </th>
         <td>
      ...
      <tr>
         <th>
            ...
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'A cor do texto e borda será obtida a partir da cor informada.' ) ?></span>
         </th>
         <td>
      ...
      <tr>
         <th>
            <?php echo esc_html__( 'Tamanho do botão do popup de parcelas', 'woo-custom-installments' ) ?>
         </th>
         <td>
      ...
      <tr>
         <th>
            ...
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'Raio da borda do botão de popup de parcelas.' ) ?></span>
         </th>
         <td>
            <div class="input-group">
      ...
      <tr>
         <th>
            ...
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'Cor para ser utilizada na informação de melhor parcela com ou sem juros.' ) ?></span>
         </th>
         <td>
      ...
      <tr>
         <th>
            <?php echo esc_html__( 'Ícone da exibição das parcelas', 'woo-custom-installments' ) ?>
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'Informe uma classe de ícone do Font Awesome. Ou deixe em branco para não exibir.' ) ?></span>
         </th>
         <td>
