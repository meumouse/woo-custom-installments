...
<div id="design" class="nav-content">
   <table class="form-table">
        ...
        <th>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="enable_force_styles" name="enable_force_styles" value="yes" <?php checked( Init::get_setting('enable_force_styles') === 'yes' ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="center_group_elements_loop" name="center_group_elements_loop" value="yes" <?php checked( Init::get_setting('center_group_elements_loop') === 'yes' ); ?> />
                        ...
                        <table class="popup-table">
                           <tbody>
                              <tr>
                                 ...
                                 <td>
                                    <textarea class="form-control" id="selectors_group_for_center_elements" name="selectors_group_for_center_elements"><?php echo Init::get_setting('selectors_group_for_center_elements'); ?></textarea>
                                 </td>
                              </tr>
                           </tbody>
                        </table>
      ...
      <tr>
        ...
        <td>
           <div class="form-check form-switch">
              <input type="checkbox" class="toggle-switch" id="enable_elementor_widgets" name="enable_elementor_widgets" value="yes" <?php checked( Init::get_setting('enable_elementor_widgets') === 'yes' ); ?> />
           </div>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
           <div class="form-check form-switch">
              <input type="checkbox" class="toggle-switch" id="enable_price_grid_in_widgets" name="enable_price_grid_in_widgets" value="yes" <?php checked( Init::get_setting('enable_price_grid_in_widgets') == 'yes' ); ?> />
           </div>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
           <div class="form-check form-switch">
              <input type="checkbox" class="toggle-switch" id="enable_update_variation_prices_elements" name="enable_update_variation_prices_elements" value="yes" <?php checked( Init::get_setting('enable_update_variation_prices_elements') === 'yes' ); ?> />
           </div>
        </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <select id="icon_format_elements" class="form-select input-control-wd-20" name="icon_format_elements">
               <option value="class" <?php echo ( Init::get_setting('icon_format_elements') === 'class' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Classe de ícone (Font Awesome) - (Padrão)', 'woo-custom-installments' ) ?></option>
               <option value="upload" <?php echo ( Init::get_setting('icon_format_elements') === 'upload' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Enviar ícones', 'woo-custom-installments' ) ?></option>
            </select>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div id="reorder_wci_elements">
               <ul class="sortable">
                  <?php foreach ( Init::get_setting('elements_design') as $element => $value ) : ?>
      ...
      <tr>
         ...
         <td>
            <div class="input-group color-container">
               <input type="text" id="button_popup_color" name="button_popup_color" class="form-control input-color" data-format="rgb" data-opacity="1" data-position="bottom" value="<?php echo Init::get_setting('button_popup_color') ?>" size="25">
      ...
      <tr>
         ...
         <td>
            <select id="button_popup_size" class="form-select input-control-wd-10" name="button_popup_size">
               <option value="small" <?php echo ( Init::get_setting('button_popup_size') === 'small' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Pequeno', 'woo-custom-installments' ) ?></option>
               <option value="normal" <?php echo ( Init::get_setting('button_popup_size') === 'normal' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Normal', 'woo-custom-installments' ) ?></option>
               <option value="large" <?php echo ( Init::get_setting('button_popup_size') === 'large' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Grande', 'woo-custom-installments' ) ?></option>
               <option value="link" <?php echo ( Init::get_setting('button_popup_size') === 'link' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Link', 'woo-custom-installments' ) ?></option>
            </select>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="input-group">
               <input type="text" name="margin_top_popup_installments" class="form-control input-control-wd-5 design-parameters" value="<?php echo Init::get_setting( 'margin_top_popup_installments' ) ?>"/>
               <select id="unit_margin_top_popup_installments" class="form-select" name="unit_margin_top_popup_installments">
                  <option value="px" <?php echo ( Init::get_setting('unit_margin_top_popup_installments') === 'px' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'px', 'woo-custom-installments' ) ?></option>
                  <option value="em" <?php echo ( Init::get_setting('unit_margin_top_popup_installments') === 'em' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'em', 'woo-custom-installments' ) ?></option>
                  <option value="rem" <?php echo ( Init::get_setting('unit_margin_top_popup_installments') === 'rem' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'rem', 'woo-custom-installments' ) ?></option>
               </select>
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="input-group">
               <input type="text" name="margin_bottom_popup_installments" class="form-control input-control-wd-5 design-parameters" value="<?php echo Init::get_setting( 'margin_bottom_popup_installments' ) ?>"/>
               <select id="unit_margin_bottom_popup_installments" class="form-select" name="unit_margin_bottom_popup_installments">
                  <option value="px" <?php echo ( Init::get_setting('unit_margin_bottom_popup_installments') === 'px' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'px', 'woo-custom-installments' ) ?></option>
                  <option value="em" <?php echo ( Init::get_setting('unit_margin_bottom_popup_installments') === 'em' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'em', 'woo-custom-installments' ) ?></option>
                  <option value="rem" <?php echo ( Init::get_setting('unit_margin_bottom_popup_installments') === 'rem' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'rem', 'woo-custom-installments' ) ?></option>
               </select>
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="input-group">
               <input type="text" name="border_radius_popup_installments" class="form-control input-control-wd-5 allow-number-and-dots" value="<?php echo Init::get_setting( 'border_radius_popup_installments' ) ?>"/>
               <select id="unit_border_radius_popup_installments" class="form-select" name="unit_border_radius_popup_installments">
                  <option value="px" <?php echo ( Init::get_setting('unit_border_radius_popup_installments') === 'px' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'px', 'woo-custom-installments' ) ?></option>
                  <option value="em" <?php echo ( Init::get_setting('unit_border_radius_popup_installments') === 'em' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'em', 'woo-custom-installments' ) ?></option>
                  <option value="rem" <?php echo ( Init::get_setting('unit_border_radius_popup_installments') === 'rem' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'rem', 'woo-custom-installments' ) ?></option>
               </select>
            </div>
         </td>
      </tr>
