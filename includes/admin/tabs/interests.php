      ...
      <tr>
        ...
        <td>
            <div class="form-check form-switch">
                <input type="checkbox" class="toggle-switch" id="enable_all_interest_options" name="enable_all_interest_options" value="yes" <?php checked( Init::get_setting( 'enable_all_interest_options') == 'yes' ); ?> />
            </div>
        </td>
      </tr>
      ...
      <tr class="display-enable-all-interest-options">
         ...
         <td>
            <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="display_tag_interest_checkout" name="display_tag_interest_checkout" value="yes" <?php checked( Init::get_setting( 'display_tag_interest_checkout') == 'yes' && License::is_valid() ); ?> />
            </div>
         </td>
      </tr>
