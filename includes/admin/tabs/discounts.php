    ...
    <table class="form-table">
      ...
      <tr class="display-enable-all-discount-options">
        ...
        <td>
            <div class="form-check form-switch <?php echo ( self::license_valid() ) ? '': 'pro-version-notice'; ?>">
                <input type="checkbox" class="toggle-switch <?php echo ( self::license_valid() ) ? '': 'pro-version'; ?>" id="include_shipping_value_in_discounts" name="include_shipping_value_in_discounts" value="yes" <?php checked( self::get_setting( 'include_shipping_value_in_discounts') == 'yes' && self::license_valid() ); ?> />
            </div>
        </td>
      </tr>
      <tr class="display-enable-all-discount-options">
         ...
         <td>
               <div class="form-check form-switch <?php echo ( self::license_valid() ) ? '': 'pro-version-notice'; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( self::license_valid() ) ? '': 'pro-version'; ?>" id="display_discount_price_schema" name="display_discount_price_schema" value="yes" <?php checked( self::get_setting( 'display_discount_price_schema') == 'yes' && self::license_valid() ); ?> />
               </div>
         </td>
      </tr>
      <tr class="display-enable-all-discount-options">
         ...
         <td>
               <div class="form-check form-switch <?php echo ( self::license_valid() ) ? '': 'pro-version-notice'; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( self::license_valid() ) ? '': 'pro-version'; ?>" id="enable_post_meta_feed_xml_price" name="enable_post_meta_feed_xml_price" value="yes" <?php checked( self::get_setting( 'enable_post_meta_feed_xml_price') === 'yes' && self::license_valid() ); ?> />
               </div>
         </td>
      </tr>
      ...
      <tr class="display-enable-all-discount-options">
         ...
         <td class="d-flex align-items-center">
            <div class="form-check form-switch <?php echo ( self::license_valid() ) ? '': 'pro-version-notice'; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( self::license_valid() ) ? '': 'pro-version'; ?>" id="enable_functions_discount_per_quantity" name="enable_functions_discount_per_quantity" value="yes" <?php checked( self::get_setting( 'enable_functions_discount_per_quantity') == 'yes' && self::license_valid() ); ?> />
            </div>
      ...
      <tr class="display-enable-all-discount-options">
         ...
         <td>
            <div class="form-check form-switch <?php echo ( self::license_valid() ) ? '': 'pro-version-notice'; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( self::license_valid() ) ? '': 'pro-version'; ?>" id="display_tag_discount_price_checkout" name="display_tag_discount_price_checkout" value="yes" <?php checked( self::get_setting( 'display_tag_discount_price_checkout') == 'yes' && self::license_valid() ); ?> />
            </div>
         </td>
      </tr>
      <tr class="display-enable-all-discount-options">
            ...
            <td class="wci-title-method-discount-div">
               <div class="input-group wci-method-discount-selector" id="foreach-payment-<?php echo esc_attr( $gateway->id ); ?>-method-discount" name="form-discount-<?php echo esc_attr( $gateway->id ); ?>-method">
                  <span id="discount-method-result-payment-method-<?php echo esc_attr( $gateway->id ); ?>" class="input-group-text discount-method-result-payment-method" name="discount-method-result-payment-method[<?php echo esc_attr( $gateway->id ); ?>][type]">
                     <?php echo ( isset( $discountSettings[ $gateway->id ]['type'] ) && $discountSettings[ $gateway->id ]['type'] === 'percentage' ) ? '%' : get_woocommerce_currency_symbol(); ?>
                  </span>
                  ...
                  <select class="form-select get-discount-method-payment-method <?php echo ( self::license_valid() ) ? '': 'pro-version-notice'; ?>" id="woo-custom-installments-payment-discounts-type-<?php echo esc_attr( $gateway->id ); ?>" name="woo_custom_installments_discounts[<?php echo esc_attr( $gateway->id ); ?>][type]">
