...
<div id="discount-settings" class="nav-content ">
    <table class="form-table" >
      ...
      <tr class="display-enable-all-discount-options">
        <th>
            <?php echo esc_html__( 'Incluir valor de frete no desconto do pedido', 'woo-custom-installments' ) ?><span class="badge bg-primary rounded-pill ms-2 <?php if ( $this->responseObj->is_valid ) { echo 'd-none';} ?>"><?php echo esc_html__( 'Pro', 'woo-custom-installments' ) ?></span>
        ...
        <td>
            <div class="form-check form-switch <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version-notice';} ?>">
                <input type="checkbox" class="toggle-switch <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version';} ?>" id="include_shipping_value_in_discounts" name="include_shipping_value_in_discounts" value="yes" <?php checked( self::get_setting( 'include_shipping_value_in_discounts') == 'yes' && $this->responseObj->is_valid ); ?> />
            </div>
        </td>
      </tr>
      <tr class="display-enable-all-discount-options">
         ...
         <td>
               <div class="form-check form-switch <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version-notice';} ?>">
               <input type="checkbox" class="toggle-switch <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version';} ?>" id="display_discount_price_schema" name="display_discount_price_schema" value="yes" <?php checked( self::get_setting( 'display_discount_price_schema') == 'yes' && $this->responseObj->is_valid ); ?> />
               </div>
         </td>
      </tr>
      <tr class="display-enable-all-discount-options">
         ...
         <td>
            <div class="input-group">
               <span id="symbol_discount_pix" class="input-group-text">
                  <?php
      ...
      <tr class="display-enable-all-discount-options admin-discount-ticket-option">
         ...
         <td>
            <div class="input-group">
               <span id="symbol_discount_slip_bank" class="input-group-text">
                  <?php
      ...
      <tr class="display-enable-all-discount-options">
         ...
         <td class="d-flex align-items-center">
            <div class="form-check form-switch <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version-notice';} ?>">
               <input type="checkbox" class="toggle-switch <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version';} ?>" id="enable_functions_discount_per_quantity" name="enable_functions_discount_per_quantity" value="yes" <?php checked( self::get_setting( 'enable_functions_discount_per_quantity') == 'yes' && $this->responseObj->is_valid ); ?> />
            </div>
                  ...
                  <div class="popup-body">
                     <table class="popup-table">
                        <tr class=" disable-discount-per-product-global">
                           <th>
                              <?php echo esc_html__( 'Método do desconto por quantidade', 'woo-custom-installments' ) ?><span class="badge bg-primary rounded-pill ms-2 <?php if ( $this->responseObj->is_valid ) { echo 'd-none';} ?>"><?php echo esc_html__( 'Pro', 'woo-custom-installments' ) ?></span>
                              <span class="woo-custom-installments-description"><?php echo esc_html__( 'Se ativo, irá ser adicionado um desconto a partir de uma quantidade mínima do produto no carrinho, para todos os produtos da loja.', 'woo-custom-installments' ) ?></span>
                           </th>
                           <td>
                        ...
                        <tr class="global-discount-required">
                           ...
                           <td>
                              <div class="input-group">
                                 <span id="symbol_discount_quantity" class="input-group-text">
                                    <?php
                                       if ( self::get_setting('discount_per_quantity_method') === 'percentage' ) {
                                          echo '%';
                                       } else {
                                          echo get_woocommerce_currency_symbol();
                                       }
      ...
      <tr class="display-enable-all-discount-options">
         ...
         <td>
            <div class="form-check form-switch <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version-notice';} ?>">
               <input type="checkbox" class="toggle-switch <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version';} ?>" id="display_tag_discount_price_checkout" name="display_tag_discount_price_checkout" value="yes" <?php checked( self::get_setting( 'display_tag_discount_price_checkout') == 'yes' && $this->responseObj->is_valid ); ?> />
            </div>
         </td>
      </tr>
      <tr class="display-enable-all-discount-options">
