...
<div id="general" class="nav-content">
   <table class="form-table">
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '' : 'pro-version-notice'; ?>">
               ...
               <button id="remove_price_range_settings_trigger" class="btn btn-outline-primary ms-3 require-remove-price-range"><?php echo esc_html__( 'Configurar', 'woo-custom-installments' ) ?></button>
            
               <div id="remove_price_range_settings_container" class="popup-container">
                  <div class="popup-content">
                     <div class="popup-header">
                        <h5 class="popup-title"><?php echo esc_html__( 'Configurar remoção da faixa de preço', 'woo-custom-installments' ); ?></h5>
                        <button id="remove_price_range_settings_close" class="btn-close fs-lg" aria-label="<?php echo esc_html__( 'Fechar', 'woo-custom-installments' ) ?>"></button>
                     </div>
                     ...
                     <div class="popup-body">
                        <table class="popup-table">
                           <tbody>
                              <tr>
                                 <th>
                                    <?php echo esc_html__( 'Método de atualização do preço', 'woo-custom-installments' ) ?>
                                    <span class="woo-custom-installments-description"><?php echo esc_html__('Define o método de atualização do preço da variação.', 'woo-custom-installments' ) ?></span>
                                    <span class="woo-custom-installments-description mt-2"><?php echo esc_html__('AJAX é um método de busca do preço através do servidor, ou método Dinâmico para obter o preço da variação existente e substituindo pelo preço atual (JavaScript).', 'woo-custom-installments' ) ?></span>
                                 </th>
                                 <td>
                                    <select id="price_range_method" name="price_range_method" class="form-select <?php echo ( License::is_valid() ) ? '' : 'pro-version-notice'; ?>">
                                       <option value="ajax" <?php echo ( self::get_setting('price_range_method') === 'ajax' && License::is_valid() ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'AJAX (Padrão)', 'woo-custom-installments' ) ?></option>
                                       <option value="dynamic" <?php echo ( self::get_setting('price_range_method') === 'dynamic' && License::is_valid() ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'Dinâmico', 'woo-custom-installments' ) ?></option>
                                    </select>
                                 </td>
                              </tr>
                              ...
                              <tr class="require-dynamic-method">
                                 <th>
                                    <?php echo esc_html__( 'Gatilho para atualização', 'woo-custom-installments' ) ?>
                                    <span class="woo-custom-installments-description"><?php echo esc_html__('Permite definir elementos que ao serem clicados acionam a atualização do preço. Informe a classe ou ID separado por vírgulas: .elemento-1, .elemento-2', 'woo-custom-installments' ) ?></span>
                                 </th>
                                 <td>
                                    <input type="text" id="update_range_price_triggers" class="form-control" name="update_range_price_triggers" value="<?php echo self::get_setting('update_range_price_triggers') ?>" placeholder=".elemento-1, .elemento-2"/>
                                 </td>
                              </tr>
                           </tbody>
                        </table>
      ...
      <tr>
         <th>
            <?php echo esc_html__( 'Tipo de exibição das formas de pagamento', 'woo-custom-installments' ) ?>
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'Selecione o tipo de exibição das formas de pagamento na página de produto individual.', 'woo-custom-installments' ) ?></span>
         </th>
        <td>
     ...
     <tr class="tr-position-installment-type-button">
         ...
         <td>
           <select id="hook_payment_form_single_product" name="hook_payment_form_single_product" class="form-select <?php echo ( License::is_valid() ) ? '' : 'pro-version-notice'; ?>">
              ...
              <option value="custom_hook" <?php echo ( self::get_setting( 'hook_payment_form_single_product' ) === 'custom_hook' && License::is_valid() ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'Gancho personalizado', 'woo-custom-installments' ) ?></option>
              ...
              <option value="widget" <?php echo ( self::get_setting( 'hook_payment_form_single_product' ) === 'widget' && License::is_valid() ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'Widget para Elementor', 'woo-custom-installments' ) ?></option>
           </select>
         </td>
      </tr>
      ...
      <tr class="requires-custom-hook">
         <th>
           <?php echo esc_html__( 'Gancho personalizado das formas de pagamento', 'woo-custom-installments' );
            ...
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'Informe o gancho que deve ser exibido o botão ou sanfona de formas de pagamento.', 'woo-custom-installments' ) ?></span>
         </th>
         <td>
            <input type="text" class="form-control input-control-wd-20" name="set_custom_hook_payment_form" value="<?php echo self::get_setting('set_custom_hook_payment_form') ?>"/>
         </td>
      </tr>
  </table>
</div>