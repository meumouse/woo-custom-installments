...
<div id="general" class="nav-content">
   <table class="form-table">
      <tr>
        ...
        <td>
           <div class="form-check form-switch">
              <input type="checkbox" class="toggle-switch" id="enable_installments_all_products" name="enable_installments_all_products" value="yes" <?php checked( Init::get_setting('enable_installments_all_products') == 'yes' ); ?> />
           </div>
        </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '' : 'pro-version-notice'; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '' : 'pro-version'; ?>" id="remove_price_range" name="remove_price_range" value="yes" <?php checked( Init::get_setting('remove_price_range') == 'yes' && License::is_valid() ); ?> />
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <option value="dynamic" <?php echo ( Init::get_setting('price_range_method') === 'dynamic' && License::is_valid() ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Dinâmico (Padrão)', 'woo-custom-installments' ) ?></option>
                                       <option value="ajax" <?php echo ( Init::get_setting('price_range_method') === 'ajax' && License::is_valid() ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'AJAX', 'woo-custom-installments' ) ?></option>
                                    </select>
                                 </td>
                              </tr>
                              ...
                              <tr class="require-dynamic-method">
                                 ...
                                 <td>
                                    <input type="text" id="update_range_price_triggers" class="form-control" name="update_range_price_triggers" value="<?php echo Init::get_setting('update_range_price_triggers') ?>" placeholder=".elemento-1, .elemento-2"/>
                                 </td>
                              </tr>
                              ...
                              <tr class="starting-from">
                                    ...
                                    <td>
                                       <input type="text" class="form-control input-control-wd-20" name="text_initial_variables" value="<?php echo Init::get_setting( 'text_initial_variables' ) ?>"/>
                                    </td>
                              </tr>
                           </tbody>
                        </table>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '' : 'pro-version-notice'; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '' : 'pro-version'; ?>" id="enable_economy_pix_badge" name="enable_economy_pix_badge" value="yes" <?php checked( Init::get_setting('enable_economy_pix_badge') == 'yes' && License::is_valid() ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td class="d-flex align-items-center">
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="custom_text_after_price" name="custom_text_after_price" value="yes" <?php checked( Init::get_setting( 'custom_text_after_price') === 'yes' ); ?> />
            </div>
                     ...
                     <table class="popup-table">
                        <tbody>
                           <tr>
                              ...
                              <td class="d-flex">
                                 <div class="form-check form-switch">
                                    <input type="checkbox" class="toggle-switch" id="add_discount_custom_product_price" name="add_discount_custom_product_price" value="yes" <?php checked( Init::get_setting('add_discount_custom_product_price') === 'yes' ); ?> />
                                 </div>
                              </td>
                           </tr>
                           ...
                           <tr class="require-add-discount-custom-product-price">
                              ...
                              <td>
                                 <input type="text" class="form-control input-control-wd-20 allow-number-and-dots" name="discount_value_custom_product_price" value="<?php echo Init::get_setting('discount_value_custom_product_price') ?>"/>
                              </td>
                           </tr>
                           ...
                           <tr class="tr-custom-text-after-price">
                              ...
                              <td>
                                 <input type="text" class="form-control input-control-wd-20" name="custom_text_after_price_front" value="<?php echo Init::get_setting( 'custom_text_after_price_front' ) ?>"/>
                              </td>
                           </tr>
                        </tbody>
                     </table>
      ...
      <tr>
         ...
         <td class="d-flex align-items-center">
            <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '' : 'pro-version-notice'; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '' : 'pro-version'; ?>" id="enable_sale_badge" name="enable_sale_badge" value="yes" <?php checked( Init::get_setting('enable_sale_badge') === 'yes' && License::is_valid() ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr id="fee-global-settings">
        ...
        <td>
           <div class="input-group">
              ...
              <input type="text" id="fee_installments_global" class="form-control input-control-wd-5 allow-number-and-dots" name="fee_installments_global" value="<?php echo Init::get_setting( 'fee_installments_global' ) ?>" placeholder="2.0"/>
           </div>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
           <input type="number" id="max_qtd_installments" class="form-control allow-numbers-be-1 input-control-wd-7-7rem" name="max_qtd_installments" value="<?php echo Init::get_setting( 'max_qtd_installments' ) ?>"/>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
           <input type="number" id="max_qtd_installments_without_fee" class="form-control allow-numbers-be-0 input-control-wd-7-7rem" name="max_qtd_installments_without_fee" value="<?php echo Init::get_setting( 'max_qtd_installments_without_fee' ) ?>"/>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
           <div class="input-group input-control-wd-5">
              ...
              <input type="number" id="min_value_installments" class="form-control input-control-wd-5 allow-numbers-be-1 input-control-wd-7-7rem" name="min_value_installments" placeholder="20" value="<?php echo Init::get_setting( 'min_value_installments' ) ?>">
           </div>
        </td>
      </tr>
      ...
      <tr>
         ...
         <td class="d-flex align-items-center">
            <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '' : 'pro-version-notice'; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '' : 'pro-version'; ?>" id="set_fee_per_installment" name="set_fee_per_installment" value="yes" <?php checked( Init::get_setting( 'set_fee_per_installment') == 'yes' && License::is_valid() ); ?> />
            </div>
                           ...
                           <td>
                              <fieldset id="custom-installments-fieldset-custom-installments">
                                 <?php
                                    ...
                                    $limit_installments = Init::get_setting('max_qtd_installments');
                                    $init_loop = Init::get_setting('max_qtd_installments_without_fee') + 1;
      ...
      <tr>
        ...
        <td>
           <select name="display_discount_price_hook" class="form-select">
              <option value="display_loop_and_single_product" <?php echo ( Init::get_setting('display_discount_price_hook') === 'display_loop_and_single_product' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Mostrar em todo o site (Padrão)', 'woo-custom-installments' ) ?></option>
              <option value="only_single_product" <?php echo ( Init::get_setting('display_discount_price_hook') === 'only_single_product' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Apenas página do produto individual', 'woo-custom-installments' ) ?></option>
              <option value="only_loop_products" <?php echo ( Init::get_setting('display_discount_price_hook') === 'only_loop_products' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Apenas arquivos de produtos', 'woo-custom-installments' ) ?></option>
              <option value="hide" <?php echo ( Init::get_setting('display_discount_price_hook') === 'hide' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Ocultar', 'woo-custom-installments' ) ?></option>
           </select>
        </td>
      </tr>
      ...
      <tr class="economy-pix-dependency">
        ...
        <td>
           <select name="display_economy_pix_hook" class="form-select">
               <option value="only_single_product" <?php echo (Init::get_setting( 'display_economy_pix_hook' ) == 'only_single_product' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Apenas página do produto individual (Padrão)', 'woo-custom-installments' ) ?></option>
              <option value="global" <?php echo (Init::get_setting( 'display_economy_pix_hook' ) == 'global' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Mostrar em todo o site', 'woo-custom-installments' ) ?></option>
              <option value="only_loop_products" <?php echo (Init::get_setting( 'display_economy_pix_hook' ) == 'only_loop_products' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Apenas arquivos de produtos', 'woo-custom-installments' ) ?></option>
           </select>
        </td>
      </tr>
      ...
      <tr class="admin-discount-ticket-option">
        ...
        <td>
           <select name="display_discount_ticket_hook" class="form-select">
               <option value="global" <?php echo (Init::get_setting( 'display_discount_ticket_hook' ) == 'global' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Mostrar em todo o site (Padrão)', 'woo-custom-installments' ) ?></option>
               <option value="only_single_product" <?php echo (Init::get_setting( 'display_discount_ticket_hook' ) == 'only_single_product' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Apenas página do produto individual', 'woo-custom-installments' ) ?></option>
               <option value="only_loop_products" <?php echo (Init::get_setting( 'display_discount_ticket_hook' ) == 'only_loop_products' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Apenas arquivos de produtos', 'woo-custom-installments' ) ?></option>
           </select>
        </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <select name="hook_display_best_installments" class="form-select">
               <option value="display_loop_and_single_product" <?php echo ( Init::get_setting( 'hook_display_best_installments' ) == 'display_loop_and_single_product' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Mostrar em todo o site (Padrão)', 'woo-custom-installments' ) ?></option>
               <option value="only_single_product" <?php echo ( Init::get_setting( 'hook_display_best_installments' ) == 'only_single_product' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Apenas página do produto individual', 'woo-custom-installments' ) ?></option>
               <option value="only_loop_products" <?php echo ( Init::get_setting( 'hook_display_best_installments' ) == 'only_loop_products' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Apenas arquivos de produtos', 'woo-custom-installments' ) ?></option>
            </select>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
           <select name="get_type_best_installments" class="form-select">
              <option value="hide" <?php echo ( Init::get_setting( 'get_type_best_installments' ) == 'hide' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Ocultar', 'woo-custom-installments' ) ?></option>
              <option value="best_installment_without_fee" <?php echo ( Init::get_setting( 'get_type_best_installments' ) == 'best_installment_without_fee' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Melhor parcela sem juros', 'woo-custom-installments' ) ?></option>
              <option value="best_installment_with_fee" <?php echo ( Init::get_setting( 'get_type_best_installments' ) == 'best_installment_with_fee' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Melhor parcela com juros', 'woo-custom-installments' ) ?></option>
              <option value="both" <?php echo ( Init::get_setting( 'get_type_best_installments' ) == 'both' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Melhor parcela com e sem juros', 'woo-custom-installments' ) ?></option>
           </select>
         </td>
      </tr>
      ...
      <tr>
        ...
        <td>
           <select id="display_installment_type" name="display_installment_type" class="form-select">
              <option value="popup" <?php echo ( Init::get_setting( 'display_installment_type' ) == 'popup' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Popup (Padrão)', 'woo-custom-installments' ) ?></option>
              <option value="accordion" <?php echo ( Init::get_setting( 'display_installment_type' ) == 'accordion' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Sanfona', 'woo-custom-installments' ) ?></option>
              <option value="hide" <?php echo ( Init::get_setting( 'display_installment_type' ) == 'hide' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Ocultar', 'woo-custom-installments' ) ?></option>
           </select>
        </td>
     </tr>
     ...
     <tr class="tr-position-installment-type-button">
         <th>
           <?php esc_html_e( 'Posição das formas de pagamento e parcelas na página de produto individual', 'woo-custom-installments' );
            ...
            <span id="display-shortcode-info" class="woo-custom-installments-description mt-2 <?php echo ( Init::get_setting( 'hook_payment_form_single_product' ) != 'shortcode' ) ? "d-none" : ""; ?>"><?php esc_html_e( 'Shortcode: ', 'woo-custom-installments' ) ?><code>[woo_custom_installments_modal]</code></span>
         </th>
         <td>
           <select id="hook_payment_form_single_product" name="hook_payment_form_single_product" class="form-select <?php echo ( License::is_valid() ) ? '' : 'pro-version-notice'; ?>">
              <option value="before_cart" <?php echo ( Init::get_setting( 'hook_payment_form_single_product' ) === 'before_cart' && License::is_valid() ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Antes do carrinho (Padrão)', 'woo-custom-installments' ) ?></option>
              <option value="after_cart" <?php echo ( Init::get_setting( 'hook_payment_form_single_product' ) === 'after_cart' && License::is_valid() ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Depois do carrinho', 'woo-custom-installments' ) ?></option>
              <option value="custom_hook" <?php echo ( Init::get_setting( 'hook_payment_form_single_product' ) === 'custom_hook' && License::is_valid() ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Gancho personalizado', 'woo-custom-installments' ) ?></option>
              <option value="shortcode" <?php echo ( Init::get_setting( 'hook_payment_form_single_product' ) === 'shortcode' && License::is_valid() ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Shortcode', 'woo-custom-installments' ) ?></option>
              <option value="widget" <?php echo ( Init::get_setting( 'hook_payment_form_single_product' ) === 'widget' && License::is_valid() ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Widget para Elementor', 'woo-custom-installments' ) ?></option>
           </select>
         </td>
      </tr>
      ...
      <tr class="requires-custom-hook">
         ...
         <td>
            <input type="text" class="form-control input-control-wd-20" name="set_custom_hook_payment_form" value="<?php echo Init::get_setting('set_custom_hook_payment_form') ?>"/>
         </td>
      </tr>
  </table>
</div>