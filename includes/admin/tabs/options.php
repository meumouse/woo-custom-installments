...
<div id="general-settings" class="nav-content ">
   <table class="form-table">
      <tr>
        ...
        <td>
           <div class="form-check form-switch">
              <input type="checkbox" class="toggle-switch" id="enable_installments_all_products" name="enable_installments_all_products" value="yes" <?php checked( $this->getSetting( 'enable_installments_all_products') == 'yes' ); ?> />
           </div>
        </td>
      </tr>
      <tr>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="remove_price_range" name="remove_price_range" value="yes" <?php checked( $this->getSetting( 'remove_price_range') == 'yes' ); ?> />
            </div>
         </td>
      </tr>
      <tr>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="custom_text_after_price" name="custom_text_after_price" value="yes" <?php checked( $this->getSetting( 'custom_text_after_price') == 'yes' ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr>
        ...
        <td>
           <input type="number" id="max_qtd_installments" class="form-control allow-numbers-be-1 input-control-wd-7-7rem" name="max_qtd_installments" value="<?php echo $this->getSetting( 'max_qtd_installments' ) ?>"/>
        </td>
      </tr>
      <tr>
        <th>
        ...
        <td>
           <input type="number" id="max_qtd_installments_without_fee" class="form-control allow-numbers-be-1 input-control-wd-7-7rem" name="max_qtd_installments_without_fee" value="<?php echo $this->getSetting( 'max_qtd_installments_without_fee' ) ?>"/>
        </td>
      </tr>
      <tr>
        <th>
        ...
        <td>
           <div class="input-group input-control-wd-5">
              ...
              <input type="number" id="min_value_installments" class="form-control input-control-wd-5 allow-numbers-be-1 input-control-wd-7-7rem" name="min_value_installments" placeholder="20" value="<?php echo $this->getSetting( 'min_value_installments' ) ?>">
           </div>
        </td>
      </tr>
      <tr>
         ...
         <td>
            <div class="form-check form-switch <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version-notice';} ?>">
               <input type="checkbox" class="toggle-switch <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version';} ?>" id="set_fee_per_installment" name="set_fee_per_installment" value="yes" <?php checked( $this->getSetting( 'set_fee_per_installment') == 'yes' && $this->responseObj->is_valid ); ?> />
            </div>
         </td>
      </tr>
      <tr class="set-custom-fee-per-installment d-none">
         <th>
            <?php echo esc_html__( 'Informar juros desde a primeira parcela', 'woo-custom-installments' ) ?>
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'Se ativo, permite informar uma taxa de juros personalizada para cada parcela.', 'woo-custom-installments' ) ?></span>
         </th>
         <td>
            <input type="checkbox" class="toggle-switch" id="set_fee_first_installment" name="set_fee_first_installment" value="yes" <?php checked( $this->getSetting( 'set_fee_first_installment') == 'yes' ); ?> />
         </td>
      </tr>
      <tr class="set-custom-fee-per-installment d-none <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version';} ?>">
         <td>
            <fieldset id="custom-installments-fieldset-custom-installments">
               <?php
                  ...
                  if ( isset( $options['set_fee_first_installment'] ) && $options['set_fee_first_installment'] == 'yes' ) {
                     $init_loop = 1;
                  } else {
                     $init_loop = $this->getSetting( 'max_qtd_installments_without_fee' ) + 1;
                  }
      ...
      <tr>
        ...
        <td>
           <select name="display_discount_price_hook" class="form-select">
              <option value="display_loop_and_single_product" <?php echo ($this->getSetting( 'display_discount_price_hook' ) == 'display_loop_and_single_product' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'Mostrar em todo o site (Padrão)', 'woo-custom-installments' ) ?></option>
      ...
      <tr>
         ...
         <td>
            <select name="hook_display_best_installments" class="form-select">
               <option value="display_loop_and_single_product" <?php echo ( $this->getSetting( 'hook_display_best_installments' ) == 'display_loop_and_single_product' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'Mostrar em todo o site (Padrão)', 'woo-custom-installments' ) ?></option>
      ...
      <tr>
         <th>
            <?php echo esc_html__( 'Ordem da melhor parcela', 'woo-custom-installments' ) ?>
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'Selecione a ordem de exibição da melhor parcela.', 'woo-custom-installments' ) ?></span>
         </th>
         <td>
            <select name="hook_display_best_installments_after_before_discount" class="form-select">
              <option value="before_discount" <?php echo ( $this->getSetting( 'hook_display_best_installments_after_before_discount' ) == 'before_discount' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'Antes do desconto (Padrão)', 'woo-custom-installments' ) ?></option>
              <option value="after_discount" <?php echo ( $this->getSetting( 'hook_display_best_installments_after_before_discount' ) == 'after_discount' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'Depois do desconto', 'woo-custom-installments' ) ?></option>
           </select>
         </td>
      </tr>
      <tr class="admin-discount-ticket-option">
         <th>
            <?php echo esc_html__( 'Ordem do desconto no boleto bancário', 'woo-custom-installments' ) ?>
            <span class="woo-custom-installments-description"><?php echo esc_html__( 'Selecione a ordem de exibição da melhor parcela.', 'woo-custom-installments' ) ?></span>
         </th>
         <td>
            <select name="hook_order_discount_ticket" class="form-select">
              <option value="before_main_discount" <?php echo ( $this->getSetting( 'hook_order_discount_ticket' ) == 'before_main_discount' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'Antes do desconto principal', 'woo-custom-installments' ) ?></option>
              <option value="after_main_discount" <?php echo ( $this->getSetting( 'hook_order_discount_ticket' ) == 'after_main_discount' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'Depois do desconto principal (Padrão)', 'woo-custom-installments' ) ?></option>
           </select>
         </td>
      </tr>
      <tr>
        ...
        <td>
           <select name="display_installment_type" class="form-select">
              <option value="popup" <?php echo ( $this->getSetting( 'display_installment_type' ) == 'popup' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'Popup (Padrão)', 'woo-custom-installments' ) ?></option>
              ...
              <option value="hide" <?php echo ( $this->getSetting( 'display_installment_type' ) == 'hide' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'Ocultar', 'woo-custom-installments' ) ?></option>
           </select>
        </td>
     </tr>
     <tr class="tr-position-installment-type-button">
        <th>
           ...
           <span id="display-shortcode-info" class="woo-custom-installments-description mt-2 <?php echo ( $this->getSetting( 'hook_payment_form_single_product' ) != 'shortcode' ) ? "d-none" : ""; ?>"><?php echo esc_html__( 'Shortcode: ', 'woo-custom-installments' ) ?><code>[woo_custom_installments_modal]</code></span>
       </th>
        <td>
           <select name="hook_payment_form_single_product" class="form-select <?php if ( ! $this->responseObj->is_valid ) { echo 'pro-version-notice';} ?>">
     ...
     <tr>
        ...
        <td>
           <div class="form-check form-switch">
              <input type="checkbox" class="toggle-switch" id="disable_update_checkout" name="disable_update_checkout" value="yes" <?php checked( $this->getSetting( 'disable_update_checkout') == 'yes' ); ?> />
           </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
           <div class="form-check form-switch">
              <input type="checkbox" class="toggle-switch" id="disable_update_installments" name="disable_update_installments" value="yes" <?php checked( $this->getSetting( 'disable_update_installments') == 'yes' ); ?> />
           </div>
        </td>
      </tr>
  </table>
