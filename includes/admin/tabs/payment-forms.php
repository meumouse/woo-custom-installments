...
<div id="payment" class="nav-content">
    <table class="form-table">
      <tr>
         ...
         <td>
            <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_pix_method_payment_form" name="enable_pix_method_payment_form" value="yes" <?php checked( self::get_setting( 'enable_pix_method_payment_form') == 'yes' && License::is_valid() ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_ticket_method_payment_form" name="enable_ticket_method_payment_form" value="yes" <?php checked( self::get_setting( 'enable_ticket_method_payment_form') == 'yes' && License::is_valid() ); ?> />
            </div>
         </td>
      </tr>
                     ...
                     <div class="popup-body">
                        <table class="popup-table">
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_mastercard_flag_credit" name="enable_mastercard_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_mastercard_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_visa_flag_credit" name="enable_visa_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_visa_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_elo_flag_credit" name="enable_elo_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_elo_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_hipercard_flag_credit" name="enable_hipercard_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_hipercard_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_diners_club_flag_credit" name="enable_diners_club_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_diners_club_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_discover_flag_credit" name="enable_discover_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_discover_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_american_express_flag_credit" name="enable_american_express_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_american_express_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_paypal_flag_credit" name="enable_paypal_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_paypal_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_stripe_flag_credit" name="enable_stripe_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_stripe_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_mercado_pago_flag_credit" name="enable_mercado_pago_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_mercado_pago_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_pagseguro_flag_credit" name="enable_pagseguro_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_pagseguro_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_pagarme_flag_credit" name="enable_pagarme_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_pagarme_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_cielo_flag_credit" name="enable_cielo_flag_credit" value="yes" <?php checked( self::get_setting( 'enable_cielo_flag_credit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                        </table>
                     ...
                     <div class="popup-body">
                        <table class="popup-table">
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_mastercard_flag_debit" name="enable_mastercard_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_mastercard_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_visa_flag_debit" name="enable_visa_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_visa_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_elo_flag_debit" name="enable_elo_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_elo_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_hipercard_flag_debit" name="enable_hipercard_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_hipercard_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_diners_club_flag_debit" name="enable_diners_club_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_diners_club_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_discover_flag_debit" name="enable_discover_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_discover_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_american_express_flag_debit" name="enable_american_express_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_american_express_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_paypal_flag_debit" name="enable_paypal_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_paypal_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_stripe_flag_debit" name="enable_stripe_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_stripe_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_mercado_pago_flag_debit" name="enable_mercado_pago_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_mercado_pago_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_pagseguro_flag_debit" name="enable_pagseguro_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_pagseguro_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_pagarme_flag_debit" name="enable_pagarme_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_pagarme_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="form-check form-switch <?php echo ( License::is_valid() ) ? '': 'pro-version-notice'; ?>">
                                    <input type="checkbox" class="toggle-switch <?php echo ( License::is_valid() ) ? '': 'pro-version'; ?>" id="enable_cielo_flag_debit" name="enable_cielo_flag_debit" value="yes" <?php checked( self::get_setting( 'enable_cielo_flag_debit') == 'yes' && License::is_valid() ); ?> />
                                 </div>
                              </td>
                           </tr>
                        </table>
