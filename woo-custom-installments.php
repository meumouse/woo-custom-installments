...
class Woo_Custom_Installments {
		...
		public function __construct() {
			$this->slug = 'woo-custom-installments';
			$this->version = '3.0.0';
		...
		public function setup_constants() {
			// Plugin basename
			if ( ! defined( 'WOO_CUSTOM_INSTALLMENTS_BASENAME' ) ) {
				define( 'WOO_CUSTOM_INSTALLMENTS_BASENAME', plugin_basename( __FILE__ ) );
			}
		...
		public function setup_includes() {
			 ...
			 * @since 2.0.0
			 */
			if ( get_option( 'woo_custom_installments_license_status' ) == 'valid' && isset( $options['enable_all_discount_options'] ) == 'yes' ) {
			 ...
			 * @since 2.3.5
			 */
			if ( get_option( 'woo_custom_installments_license_status' ) == 'valid' && isset( $options['enable_all_interest_options'] ) == 'yes' ) {
			 ...
			 * @since 2.1.0
			 */
			include_once WOO_CUSTOM_INSTALLMENTS_DIR . 'includes/classes/class-woo-custom-installments-custom-design.php';
			 ...
			 * @since 2.0.0
			 */
			include_once WOO_CUSTOM_INSTALLMENTS_DIR . 'includes/classes/class-woo-custom-installments-api.php';
			 ...
			 * @since 3.0.0
			 */
			include_once WOO_CUSTOM_INSTALLMENTS_DIR . 'includes/classes/class-woo-custom-installments-updater.php';
		}
 ...
 */
function Woo_Custom_Installments() {
